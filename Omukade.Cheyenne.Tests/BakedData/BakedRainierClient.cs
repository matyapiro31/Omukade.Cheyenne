...
using SharedLogicUtils.source.Permissions;
...
namespace Omukade.Cheyenne.Tests.BakedData
{
    public struct BakedRainierClient : IRainierClient
    {
        ...
        public FeatureFlagService FeatureFlagService => throw new NotImplementedException();
        public PermissionsService PermissionsService => throw new NotImplementedException();
        ...
        public Task<bool> SwitchOffline(bool useOffline, MatchMakerTimerSettings matchMakerTimerSettings)
        {
            throw new NotImplementedException();
        }

        public void StartOfflineMessageHandler(OfflineClient offlineClient, IReadOnlyDictionary<string, bool> featureFlags)
        {
            throw new NotImplementedException();
        }
